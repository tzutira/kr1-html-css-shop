...
GitHub Pages: https://tzutira.github.io/kr1-html-css-shop/
...
- поля формы: имя, e-mail, телефон, дата связи, тема заявки и комментарий;
- флажок согласия на обработку данных;
- базовая HTML-валидация полей;
- подсветка некорректно заполненных полей;
